const GameScene = ({ gameState, timer, interruptionDetected }) => {
    ...
    useEffect(() => {
        ...
        const animate = () => {
            ...
            // Always show completed castle - no building stages
            if (scene.userData.houseParts) {
                // Check if castle is already shown
                const foundation = scene.userData.houseParts.foundation;
                if (foundation && foundation.material.opacity === 0) {
                    console.log('Showing completed castle');
